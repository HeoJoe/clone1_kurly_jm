...
const MDRecommend = () => {
  const categories = ["간편식·밀키트·샐러드", "과일·견과·쌀", "국·반찬·메인요리", "헤어·바디·구강", "정육·가공육·계란", "생수·음료", "커피·차", "베이커리", "스킨케어·메이크업",
                      "채소", "수산·해산·건어물", "생활용품·리빙", "면·양념·오일", "주방용품", "간식·과자·떡", "전통주", "가전제품", "가구·인테리어", "건강식품", "유아동",
                      "와인·위스키", "반려동물", "패션잡화"];
